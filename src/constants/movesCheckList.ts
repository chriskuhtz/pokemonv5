export const movesCheckList: {
	...
	{ name: 'pay-day', url: 'https://pokeapi.co/api/v2/move/6/', handled: true },
	{
		name: 'fire-punch',
	...
	{ name: 'cut', url: 'https://pokeapi.co/api/v2/move/15/', handled: true },
	...
	{ name: 'fly', url: 'https://pokeapi.co/api/v2/move/19/', handled: true },
